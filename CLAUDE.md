...
- [角色精调_新会话启动指南](Design/进度/角色精调_新会话启动指南.md) — **角色线精调新会话入口**（轻量路由表，取代直接读讨论进度）
- [叙事包扩展与demo压缩_讨论进度](Design/进度/叙事包扩展与demo压缩_讨论进度.md) — 秦线内核 + 披露层 3 坐标已落盘，完整讨论历史仅追溯用
- [叙事重写_Kimi接入与审校方案_讨论进度](Design/进度/叙事重写_Kimi接入与审校方案_讨论进度.md) — Z 方案 3 事件测试完成，待封装 kimi_rewrite.py
- [文字马赛克美术背景_落地进度](Design/进度/文字马赛克美术背景_落地进度.md) — A 路水墨化升级 M1'-M4 落地，M5/M6 可选
