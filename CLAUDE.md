...
- [文字马赛克美术背景_落地进度](Design/进度/文字马赛克美术背景_落地进度.md) — 基础设施稳定；决策点 7 收口搁置 + 决策点 8 边界处理收口；边缘 fade 锋利度精挑作储备
- [阶段3事件设计_预启动](Design/进度/阶段3事件设计_预启动.md) — **预启动**：6 线精调完成后的事件卡颗粒度撰写，当前可启动
- [intro_全盘重新设计_预启动](Design/进度/intro_全盘重新设计_预启动.md) — **进行中**：美术表现轨精调收尾；事件设计轨新发现议题"事件背景渲染层架构"（IntroSequence 永久接管 vs 事件背景切换的设计冲突，2026-05-08 由 Phase A 跑测暴露），待启动决议
